...
public class GameScreen extends ScreenAdapter {
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.tomokazu.kawano.jumpactiongame");
    ...
    private void updatePlaying(float delta) {
        ...
        if (Gdx.input.isTouched()) {
            ...
            Rectangle right = new Rectangle(GUI_WIDTH / 2, 0, GUI_WIDTH / 2, CAMERA_HEIGHT);
