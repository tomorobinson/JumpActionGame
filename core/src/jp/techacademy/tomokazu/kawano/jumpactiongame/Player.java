...
public class Player extends GameObject {
    ...
    public void update(float delta, float accelX) {
        ...
        // deltaは前の更新から今の更新までの間の時間
        // x軸方向の加速度

        velocity.add(0, GameScreen.GRAVITY * delta); //y軸方向の速度の更新
        velocity.x = -accelX / 10 * PLAYER_MOVE_VELOCITY; //横軸方向の速度の更新
        setPosition(getX() + velocity.x * delta, getY() + velocity.y * delta); //プレイヤーの位置の更新
